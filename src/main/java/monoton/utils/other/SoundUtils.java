...
public class SoundUtils implements IMinecraft {
    ...
    public static void playSound(String sound, float value) {
        new Thread(() -> {
            ...
            try {
                ...
                InputStream is = mc.getResourceManager().getResource(new ResourceLocation("monoton/sounds/" + sound)).getInputStream();
