...
public class Timer extends Module {
    ...
    public ModeSetting mode = new ModeSetting("Mode", "Обычный", "Обычный", "Grim");

    public BindSetting grimBind = new BindSetting("Кнопка буста", 0).setVisible(() -> mode.is("Grim"));

    public SliderSetting timerAmount = new SliderSetting("Скорость", 2, 1, 5, 0.025f);

    public BooleanOption smart = new BooleanOption("Умный", true).setVisible(() -> !mode.is("Grim"));
